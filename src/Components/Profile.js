...
const Profile = () => {
    ...
    return (
      ...
      <div className='max-w-lg p-8 sm:flex sm:space-x-6 bg-emerald-500 rounded-lg'>
          ...
          <div className='flex flex-col items-center justify-center'>
            <div className='flex flex-wrap gap-x-2 gap-y-2'>
              <div className='relative flex-shrink-0'>
                ...
                <img
                  src={user?.photoURL ? user.photoURL : 'no img found'}
                  referrerPolicy='no-referrer'
                  alt=''
                  className=' border w-32 h-32 rounded-md bg-gray-500 border-gray-700'
                />
              </div>
            </div>
          </div>
        ...
        <div className='flex flex-col space-y-4'>
          ...
          <div className='space-y-1'>
            ...
            <span className='flex items-center space-x-2 w-full'>
              <span className='text-white text-small w-full'>
                {' '}
                ID: {user?.uid}
              </span>
            </span>
